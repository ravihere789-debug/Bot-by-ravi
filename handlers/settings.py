...
async def speed_select(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    user_id = update.effective_user.id
    settings = get_settings(user_id)
    current = settings.get("speed", "normal")

    lines = [
        "⚡ *SPEED SETTING*",
        "━━━━━━━━━━━━━━━━━━━━━━━━━━\n",
        "Controls how fast accounts run during a campaign.\n",
        "🐢 *Slow* — 3 workers · 3–5 s delay · safest",
        "🚶 *Normal* — 10 workers · 0.8–2 s delay · balanced",
        "🐇 *Fast* — 20 workers · 0.3–0.8 s delay · higher risk",
        "⚡ *Ultra* — 30 workers · 0.1–0.3 s delay · max speed",
        "🧠 *Smart* — 15 workers · 0.3–2.5 s *random* delay · fast + safe\n",
